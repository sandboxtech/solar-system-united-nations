return function(M)
    ...
    M.market_items = {
        ...
        {name = 'production-science-pack', base_price = 160, group = 'science'},
        {name = 'utility-science-pack', base_price = 150, group = 'science'},
        {name = 'space-science-pack', base_price = 2, group = 'science'},
        {name = 'metallurgic-science-pack', base_price = 150, group = 'science'},
        {name = 'agricultural-science-pack', base_price = 10, group = 'science'},
        {name = 'electromagnetic-science-pack', base_price = 70, group = 'science'},
